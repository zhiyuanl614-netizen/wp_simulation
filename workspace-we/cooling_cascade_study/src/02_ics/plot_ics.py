...
def main():
    ...
    fig.suptitle("Early-warning comparison (detection signal: municipal supply pressure)",
                 fontsize=12.5)
    ...
    a.set_title("(a) Municipal head & detection instant")
    ...
    a.set_title("(b) Pool water level"); a.set_ylabel("Level (m)"); a.set_xlabel("Time (min)")
    ...
    a.set_title("(c) Condenser back-pressure")
    ...
    a.set_title("(d) Power deficit (unserved power)")
