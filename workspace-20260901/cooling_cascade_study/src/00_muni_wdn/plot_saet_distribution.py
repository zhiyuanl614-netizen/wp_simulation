...
def main():
    ...
    for tag, r in reps.items():
        j = r["node"]
        ax3.scatter([nc[j][0]], [nc[j][1]], marker="o", s=210, edgecolor="black",
                    facecolor="none", linewidths=1.4, zorder=5)
    ...
    ax3.text(0.99, 0.02, "rings = stratified representative nodes",
