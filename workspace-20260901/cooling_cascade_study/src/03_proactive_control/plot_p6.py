...
def main():
    ...
    fig, ax = plt.subplots(1, 3, figsize=(14, 5.0))
    ...
    a.set_title("(a)", fontsize=12, fontweight="bold", loc="left"); a.legend()
    ...
    a.set_title("(b)", fontsize=12, fontweight="bold", loc="left"); a.legend()
