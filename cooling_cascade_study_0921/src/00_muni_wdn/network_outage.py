...
==========================================================================
研究焦点 (区别于 boundary_generator 的"6 指定取水节点错峰"): 模拟 D-town **唯一水源
...
输出:
  ...
  figures/Fig6_network_outage_spatiotemporal.png (由 plot_network_outage.py 绘制:
    ① 全网压力统计随时间 ② 失压节点占比 ③–⑥ 空间快照)
