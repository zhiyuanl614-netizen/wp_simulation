...
==========================================
v2 (2026-09-15 重构): 总体改为耦合层指定的 **6 台**凝汽式机组
(coupling_map.json 中 Pg>0 者 = 全部 6 台, ΣPg=2631 MW);
k = 1..6 全枚举; 每 k: 最坏子集(按 Pg 降序 top-k) + 3 个固定种子随机子集
(k≥4 时随机子集与最坏子集可能重合, 因 C(6,k) 有限, 属预期)。

每子集两策略 (ProactiveLP, DC 潮流, horizon 300 min / dt 5 min;
  horizon 由 200 扩至 300 以覆盖 6 台中最大 SAET 185.5 min 的 SP 软着陆):
