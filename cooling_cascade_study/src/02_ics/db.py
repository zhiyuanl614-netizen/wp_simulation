...
class ICSDatabase:
    ...
    def __init__(self, db_path="../../results/ics/ics_sim.db", reset=True):
    ...
    def _create_tables(self):
        ...
        c.execute('''CREATE TABLE IF NOT EXISTS network_snapshot (
            ...
            power_deficit_MW REAL, warned INTEGER, fault_active INTEGER)''')
        self.conn.commit()
