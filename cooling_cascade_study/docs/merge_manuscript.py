...
def main():
    ...
    # ---- 题目（硬编码；骨架文件已于 2026-09-16 清理移除）----
    title_zh = "基于早期预警的冷却水耦合水-电信息物理系统韧性提升"
    title_en = "Early-warning-based resilience enhancement of cooling-water-coupled water–power cyber-physical systems"
